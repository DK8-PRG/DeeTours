...
var displayMap = exports.displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoia2ltaG9hbmdkIiwiYSI6ImNsd2plZXp2ODB3ZzAyanJ5ZTY4aDJ5NG0ifQ.kYcKv9W-AUB-0O1MeZ6LmQ';
  var map = new mapboxgl.Map({
    container: 'map',
    // container ID
    style: 'mapbox://styles/kimhoangd/clwjffxmk00jc01pc13hn4jyg',
    // style URL
    scrollZoom: false
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("<p>Day ".concat(loc.description, "</p>")).addTo(map);
  ...
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 3:
          res = _context2.sent;
          if (res.data.status = 'success') (0, _alert.showAlert)('success', 'Your successfully logged out.');
          location.replace('/');
          _context2.next = 11;
          break;
        case 8:
...
var signup = exports.signup = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(name, email, password, passwordConfirmation) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          role = _args.length > 4 && _args[4] !== undefined ? _args[4] : 'user';
          _context.prev = 1;
          _context.next = 4;
          return (0, _axios.default)({
            method: 'POST',
            ...
            data: {
              ...
              role: role // přidání role do dat odesílaných na server
            }
          });
        case 4:
          res = _context.sent;
          if (res.data.status === 'success') {
            (0, _alert.showAlert)('success', 'Registered successfully! Logging you in...');
            window.setTimeout(function () {
              location.assign('/');
            }, 1500);
          }
...
var bookTour = exports.bookTour = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(tourId) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          stripe = Stripe('pk_test_51PNvdxGdJmdHaCe0kGZpD1y8Y5J9UYr28NkbC0KMq3CvFg8Zhn1PN3V5LOBj7lXqeZgsc9aZk91vw3Cn4RECtDxr000lBLGXZ8');
          _context.prev = 1;
          _context.next = 4;
